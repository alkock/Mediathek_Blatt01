...
class AusleiheMedienauflisterWerkzeug extends ObservableSubWerkzeug {
	...
	/**
	 * Initialisiert ein neues AusleiheMedienauflisterWerkzeug. E wird die
	...
	private void setzeAnzuzeigendeMedien() {
		...
		for (Medium medium : medienListe) {
			...
			medienFormatierer.add(new AusleiheMedienFormatierer(medium, istVerliehen));
		}
	...
	/**
	 * Registriert die Aktion, die ausgeführt wird, wenn ein Medium ausgewählt wird.
	 */
	...
	public List<Medium> getSelectedMedien() {
		...
		ObservableList<AusleiheMedienFormatierer> selectedRows = _ui.getMedienAuflisterTable().getSelectionModel()
				.getSelectedItems();
