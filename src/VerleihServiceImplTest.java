...
public class VerleihServiceImplTest
{
    ...
    @Test
    public void testeEntliehendeMedienFunktioniert()
    {
    	List<Medium> abc = new LinkedList<Medium>();
    	abc.add(_abbey);
    	abc.add(_bad);
    	_verleihService.verleiheAn(_homer, abc, Datum.heute());
    	assertTrue(_verleihService.istVerliehen(_abbey));
    	assertTrue(_verleihService.istVerliehen(_bad));
    }

    @Test
    public void zuruecknehmenMedienNachAusleihen()
    {
    	List<Medium> abc = new LinkedList<Medium>();
    	abc.add(_abbey);
    	abc.add(_bad);
    	...
    	_verleihService.nimmZurueck(abc, Datum.heute());
